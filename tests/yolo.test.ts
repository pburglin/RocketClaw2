...
describe('yolo mode', () => {
  it('auto-approves guarded write execution when yolo mode is enabled', async () => {
    ...
    const result = await runToolWithPolicy(config, { toolId: 'file-management', action: 'write', approved: false });
