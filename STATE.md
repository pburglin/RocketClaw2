...
- `harness-run`, `harness-plan`, `harness-run-plan`, and `auto-code` verbose mode now stream LLM text by default while still printing formatted request/response inspection blocks.
