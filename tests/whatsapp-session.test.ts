...
import { clearWhatsAppSession, loadWhatsAppSession, saveWhatsAppSession } from '../src/messaging/whatsapp-session.js';

describe('whatsapp session profile', () => {
  it('saves, loads, and clears a local session profile', async () => {
